...
Example Configuration Directives split_clients The ngx_http_split_clients_module module creates variables suitable for A/B testing, also known as split testing.
...
|-----------|--------|---------|---------|
| `split_clients` | split_clients string $variable { ... } | — | http |
